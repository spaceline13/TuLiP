...
var LocalAutocomplete = function LocalAutocomplete(_ref) {
  ...
  var handleStateChange = function handleStateChange(changes) {
    if (typeof changes.inputValue === 'string') {
      var filteredItems = items.filter(function (item) {
        return item[primaryItemOpt].toLowerCase().includes(changes.inputValue.toLowerCase());
      });
...
var _default = LocalAutocomplete;
exports.default = _default;

//# sourceMappingURL=LocalAutocomplete.js.map